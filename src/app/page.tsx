          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {currentUser.role === 'admin' && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-850 transition-all rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 cursor-pointer shadow-sm bg-white dark:bg-slate-900"
              >
            ...
            {/* Profiles Block */}
            <div className="flex items-center border-l border-slate-200 dark:border-slate-800 pl-3 gap-3">
              ...
              <button
                ...
                className="p-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-55 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 transition-all rounded-xl cursor-pointer shadow-sm bg-white dark:bg-slate-900"
              >
                {theme === 'dark' ? (
              ...
              <button
                ...
                title="Đăng xuất"
                className="p-2 border border-red-100 dark:border-red-950/40 hover:bg-red-50 dark:hover:bg-red-950/20 hover:border-red-200 hover:text-red-650 transition-all rounded-xl text-red-500 cursor-pointer shadow-sm bg-red-50/20 dark:bg-red-950/10"
              >
        ...
        <header className="bg-white dark:bg-slate-950/60 text-slate-800 dark:text-white rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm border border-slate-200 dark:border-white/5 relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0 z-10 w-full md:w-auto">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-400 transition-all font-semibold text-xs rounded-xl shadow-md cursor-pointer hover:shadow-indigo-500/20 text-white w-full md:w-auto"
            >
